...
nhsdigital.mortality %>%
  ...
  pivot_wider(
    names_from = Date,
    names_sep = ".",
    values_from = c(SPL,`General population`)
  ) %>%
  mutate(.,pct_increase_SPL=(`SPL.2020-04-02`-`SPL.2020-03-23`)/`SPL.2020-03-23`*100,
         pct_increase_gen_pop=(`General population.2020-04-02`-`General population.2020-03-23`)/`General population.2020-03-23`*100) %>%
  kable(.,format.args = list(big.mark = ",")) %>%
  kable_styling(., full_width = F)
```

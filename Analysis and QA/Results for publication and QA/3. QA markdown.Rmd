...
#Service use statistics (removing A&E and outpatient in Wales)
...
### Pooled (excl. Wales A&E and Wales outpatient)
...
### Pooled (elective admissions, A&E and outpatient attendances, excl. Wales A&E and Wales outpatient)
...
### Pooled (emergency admissions, excl. Grampian)

```{r apr.drop.by.age.pooled.ng, echo=TRUE, message=FALSE, warning=FALSE}
pooled.ng.drop.april.by.age <- table1.all.partners.pcts %>%

...
## % reduction in activity in April 2020 vs. April 2019
...
## Emergency admissions: % reductions in April 2020 vs. April 2019

### Pooled (except Grampian)

```{r ng.apr.pct.change, echo=FALSE, message=FALSE, warning=FALSE}

drop.april.pooled.ng <- filter(table1.all.partners.pcts,strata=="overall",
                            year_month=="2020-04",partner!="Grampian",
...
```{r emadm.apr.pct.change, echo=FALSE, message=FALSE, warning=FALSE}

drop.april.ng <- filter(table1.all.partners.pcts,strata=="overall",
                            year_month=="2020-04",
                            breakdown.level %in% c("admissions_emergency")) %>%
  select(.,breakdown.level,partner,year_month,
         number.events.sdc_l1,number.events.sdc,
...
## Change in absolute numbers March-July (2020 compared to 2019)
...
### Pooled, excluding Grampian

```{r apr.drop.by.age.pooled.ng, echo=FALSE, message=FALSE, warning=FALSE}
pooled.ng.drop.april.by.age <- filter(table1.all.partners.pcts,breakdown=="age",
                            year_month=="2020-04",partner!="Grampian",
                            breakdown.level %in% c("admissions_emergency")) %>%
  select(.,partner,strata,breakdown.level,year_month,
         number.events.sdc_l1,number.events.sdc,
...
## Change in absolute numbers by age group (March to July 2020, compared to same period in 2019)
...
## Number of CEV people by age group 
